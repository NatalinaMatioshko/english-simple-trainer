...
const roadmapLessons: Lesson[] = [
  ...
  },
  {
    ...
    grammar: "adjectives; this/that/these/those; Present continuous; simple vs continuous",
    vocabulary: "days, months, seasons",
    speaking: "Say the date/season; describe objects; habits vs now",
    listening: "Test-English A1 pages (self-check on the site)",
    review: "Present Simple (L36); Present continuous preview (L34)",
    category: "general",
    status: "next",
    route: "/lesson-37",
  },
