    ...
    <div className="lesson22-page">
      <section className="lesson22-hero panel">
        <div className="lesson22-hero-top">
          <div>
            ...
            <p className="lesson22-topic-pill">
              Unit 4B · Have / Has … got?
            </p>
            <p className="lesson22-subtitle">
              Pack a bag and ask <strong>Have you got…?</strong> Answer with{" "}
        ...
        <div className="lesson22-hero-chips">
          ...
          <span>Yes, I have / No, I haven&apos;t</span>
        </div>
      </section>
      ...
      <section id="l39-exit" className="lesson22-block panel">
        ...
        <ul className="l22-goals-list">
          ...
          <li>Talk about what is in your bag with your teacher.</li>
        </ul>
