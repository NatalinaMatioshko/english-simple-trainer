...
import { CheckBar, PhotoCard } from "../components/lesson38/L38Ui";
    ...
    <div className="lesson22-page">
        ...
        <div className="lesson22-hero-top">
          <div>
            ...
            <p className="lesson22-topic-pill">
              Unit 4A · have / has got · describe people
            </p>
            <p className="lesson22-subtitle">
              Describe people with <strong>have / has got</strong>. Pack a bag
              in Lesson 39.
            </p>
          </div>
          <div
      ...
      <section id="l38-video" className="lesson22-block panel">
        <div className="lesson22-section-head">
          ...
          <p className="lesson22-section-desc">
            Watch the video with your teacher. The 4B vocabulary is in Lesson
            39.
          </p>
        </div>
        ...
        <div className="l25-cr-actions" style={{ marginTop: "1rem" }}>
          <Link className="l22-check-btn" to="/lesson-39">
            Lesson 39 · Have you got it? →
          </Link>
        </div>
      </section>
