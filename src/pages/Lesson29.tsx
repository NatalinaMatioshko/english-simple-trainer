...
/* ── Part 2 · Everyday objects (moved from Lesson 28) ───────────── */
...
export default function Lesson29() {
  ...
  // Part 1b · Everyday objects state
  ...
  // Part 1b · Everyday objects scores
  ...
  return (
    <div className="lesson22-page lesson28-page">
        ...
        <div className="lesson22-hero-top">
          <div>
            ...
            <div className="chips" style={{ marginTop: "0.75rem" }}>
              ...
              <span className="chip">this / that / these / those</span>
              <span className="chip">Numbers 1–100</span>
      ...
      {/* ── Part 1b · Everyday objects (this/that/these/those) ────── */}

      <section
        id="l29-part1b"
        className="lesson22-block panel l28-part2-goals"
        aria-label="Part 1b goals"
      >
      ...
      <section id="l29-home-office" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Vocabulary · Home office</p>
        ...
        <figure className="l28-poster">
          <img
            src={IMG28("home-office-vocab.png")}
      ...
      <section id="l29-things-photos" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Vocabulary · 1</p>
      ...
      <section id="l29-things-scene" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Vocabulary · 2</p>
          <h2>What's number…?</h2>
          <p className="lesson22-section-desc">
      ...
      <section id="l29-closeups" className="lesson22-block panel">
        <div className="lesson22-section-head">
      ...
      <section id="l29-listening-office" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Listening · 5</p>
          <h2>Listening</h2>
          <p className="lesson22-section-desc">
      ...
      <section id="l29-grammar-keys" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Grammar</p>
      ...
      <section id="l29-demonstratives" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Grammar · 8</p>
      ...
      <section id="l29-demo-charts" className="lesson22-block panel">
        <div className="lesson22-section-head">
          <p className="page-kicker">Part 1b · Grammar · summary</p>
        ...
        <div className="l28-chart-pair">
          ...
          <figure className="l28-chart">
            ...
            <img
              src={IMG28("demonstratives-chart.png")}
